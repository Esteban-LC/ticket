...
export async function POST(request: Request) {
  try {
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>Este es un mensaje automático de Tickets LICEO MICHOACANO</p>
            </div>
          </div>
        </body>
      </html>
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="margin-top: 30px;">
                Saludos,<br>
                <strong>El equipo de Tickets LICEO MICHOACANO</strong>
              </p>
            </div>
            <div class="footer">
    ...
    await sendEmail({
      to: email,
      subject: 'Confirmación de tu mensaje - Tickets LICEO MICHOACANO',
      html: userEmailHtml,
    })
