# Tickets LICEO MICHOACANO - Sistema de Soporte Técnico

Sistema de gestión de tickets y soporte al cliente para LICEO MICHOACANO, construido con Next.js, PostgreSQL y Prisma.
...
```env
DATABASE_URL="postgresql://user:password@localhost:5432/tickets_liceo_michoacano?schema=public"
