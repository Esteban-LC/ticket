  ...
  return (
    <div className="w-80 bg-gray-50 dark:bg-slate-800 border-l border-gray-200 dark:border-slate-700 overflow-y-auto">
        ...
        <div className="space-y-3">
          ...
          {ticket.customer.phone && (
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-gray-700 dark:text-gray-300">{ticket.customer.phone}</span>
            </div>
          )}
          ...
          {ticket.customer.location && (
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-gray-700 dark:text-gray-300">{ticket.customer.location}</span>
            </div>
          )}
      ...
      {ticket.tags.length > 0 && (
        <div className="p-6 border-b border-gray-200 dark:border-slate-700">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase mb-4">Etiquetas</h3>
      ...
      {/* Interactions */}
      <div className="p-6">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase mb-4">Interacciones</h3>

        {/* Tiempos del ticket */}
        <div className="mb-6 p-4 bg-gray-100 dark:bg-slate-700 rounded-lg space-y-3">
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 uppercase font-medium">Fecha de Creación</p>
          ...
          {(ticket.status === 'RESOLVED' || ticket.status === 'CLOSED') && (
            <>
              <div className="pt-3 border-t border-gray-200">
                <p className="text-xs text-gray-500 dark:text-gray-400 uppercase font-medium">Fecha de Resolución</p>
                <p className="text-sm text-gray-900 dark:text-gray-100 mt-1">
              ...
              <div className="pt-3 border-t border-gray-200">
                <p className="text-xs text-gray-500 dark:text-gray-400 uppercase font-medium">Tiempo de Resolución</p>
          ...
          {ticket.status === 'OPEN' && (
            <div className="pt-3 border-t border-gray-200">
              <p className="text-xs text-gray-500 dark:text-gray-400 uppercase font-medium">Tiempo Abierto</p>
            ...
            return (
              <div key={interaction.id} className="flex items-start space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-gray-900 dark:text-gray-100">{interaction.title}</p>
