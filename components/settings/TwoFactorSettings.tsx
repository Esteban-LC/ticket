  ...
  return (
    <div className="bg-gray-50 dark:bg-slate-800 rounded-lg shadow border border-gray-200 dark:border-slate-700 p-6">
      <div className="flex items-center space-x-3 mb-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Autenticación de Dos Factores</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">Agrega una capa adicional de seguridad a tu cuenta</p>
        </div>
      </div>
      ...
      {!showSetup ? (
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-100 dark:bg-slate-700 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Estado: {enabled ? 'Activado' : 'Desactivado'}</p>
        ...
        <div className="space-y-6">
          <div className="border-t border-gray-200 pt-4">
            <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Configura tu aplicación de autenticación</h4>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-100 dark:bg-slate-700 rounded-lg">
                ...
                <div className="flex justify-center p-4 bg-white dark:bg-slate-600 rounded-lg">
              ...
              <div className="p-4 bg-gray-100 dark:bg-slate-700 rounded-lg">
                ...
                <div className="bg-white dark:bg-slate-600 p-3 rounded border border-gray-300 dark:border-slate-500 font-mono text-sm text-center text-gray-900 dark:text-gray-100">
                  {secret}
                </div>
              </div>
              ...
              <div className="p-4 bg-gray-100 dark:bg-slate-700 rounded-lg">
                ...
                <input
                  ...
                  placeholder="000000"
                  className="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 rounded-lg text-center text-2xl font-mono tracking-widest focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
