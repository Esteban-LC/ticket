...
export default function ProfileForm({ user }: { user: User }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Información Personal</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Actualiza tu información de contacto</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                required
              />
            </div>
        ...
        <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Administra tu contraseña</p>
            </div>
            {!showPasswordForm && (
              <button
