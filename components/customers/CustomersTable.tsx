  ...
  if (customers.length === 0) {
    return (
      <div className="bg-gray-50 dark:bg-slate-800 rounded-lg shadow border border-gray-200 dark:border-slate-700 p-12 text-center">
        ...
        <p className="text-gray-400 dark:text-gray-500 mt-2">Crea tu primer cliente para comenzar</p>
      </div>
    )
  }
    ...
    <div className="bg-gray-50 dark:bg-slate-800 rounded-lg shadow border border-gray-200 dark:border-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
        {filteredCustomers.map((customer) => {
          ...
          return (
            <div key={customer.id} className="border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-700 rounded-lg p-6 hover:shadow-md transition">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-1">
                  <button
                    ...
                    className="p-2 text-gray-400 dark:text-gray-500 hover:text-green-600 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-600 disabled:opacity-50"
                  ...
                  <button
                    ...
                    className="p-2 text-gray-400 dark:text-gray-500 hover:text-primary-600 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-600"
                  >
                    <Edit2 className="h-4 w-4" />
                  </button>
                  <button
                    onClick={() => handleDelete(customer.id)}
                    className="p-2 text-gray-400 dark:text-gray-500 hover:text-red-600 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-600"
                  >
